...
data_path = '/mnt/lustre/users/ckibet/MM_DREAM/Data/Genomic_Data/MMRF_IA9_CelgeneProcessed/Strelka_SnpSift_Annotated_vcfs/indels/'
...
for variant in variants:
    consequence_data[variant] = parallelize_dataframe(pd.DataFrame(chalenge_data['WES_mutationFileStrelkaIndel'].head(737)),run_consequence)
...
consequence_data.to_csv('/mnt/lustre/users/ckibet/MM_DREAM/consequence_data_percentage_indels.csv', index=False)