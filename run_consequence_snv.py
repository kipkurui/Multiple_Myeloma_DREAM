...
data_path = '/mnt/lustre/users/ckibet/MM_DREAM/Data/Genomic_Data/MMRF_IA9_CelgeneProcessed/Strelka_SnpSift_Annotated_vcfs/snvs/'
...
consequence_data.to_csv('/mnt/lustre/users/ckibet/MM_DREAM/consequence_data_percentage_snvs.csv', index=False)